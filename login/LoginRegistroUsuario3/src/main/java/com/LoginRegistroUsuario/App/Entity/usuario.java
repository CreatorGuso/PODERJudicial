...
public class usuario{
	...
	public usuario(int n_id_usuario, String s_tipo_documento, String s_documento, String s_nombres, String s_apellidos,
			String s_direccion, String s_celular, String s_email, String clave, Byte n_activo, short n_id_perfil,
			String login, int n_id_juzgado_paz, String s_direccion_procesal, String s_casilla_judicial,
	...
	public void setClave(String s_clave) {
		this.clave = s_clave;
	}
	...
	public void setLogin(String s_login) {
		this.login = s_login;
	}
